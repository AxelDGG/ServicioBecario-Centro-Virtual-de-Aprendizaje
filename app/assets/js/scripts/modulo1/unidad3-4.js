function getPreguntas() {
    $("#ejercicio").on("submit", function(event) {
        ...
        // Get pregunta6
        let p6 = [];
        $("input[name=pregunta6]:checked").each(function() {
        ...
        // Get pregunta7
        let p7 = [];
        $("input[name=pregunta7]:checked").each(function() {
        ...
        // Get pregunta8
        let p8 = [];
        $("input[name=pregunta8]:checked").each(function() {
        ...
        // Get pregunta9
        let p9 = [];
        $("input[name=pregunta9]:checked").each(function() {
        ...
        // Get pregunta10
        let p10 = [];
        $("input[name=pregunta10]:checked").each(function() {
